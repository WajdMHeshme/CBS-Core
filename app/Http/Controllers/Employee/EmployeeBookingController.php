...
class EmployeeBookingController extends Controller
{
    ...
    public function approve(Booking $booking)
    {
        ...
        $this->notifyUsers('approved', $booking);
    ...
    public function complete(Booking $booking)
    {
        ...
        $this->notifyUsers('completed', $booking);
    ...
    public function reject(RejectBookingRequest $request, Booking $booking)
    {
        ...
        $this->notifyUsers('rejected', $booking);
     ...
     */
    private function notifyUsers(string $action, Booking $booking): void
    {
        ...
        foreach ($users as $user) {
            $user->notify(new BookingActionNotification($action, $booking->id, $by));
        }
    }
}
