                ...
                <div class="mt-6 flex flex-wrap gap-2">
                    ...
                    @if(in_array($booking->status, ['pending', 'rescheduled']))
                        ...
                        <form method="POST" action="{{ route('employee.bookings.approve', $booking->id) }}">
                            ...
                            @method('PATCH')
                            <button type="submit"
                                class="px-3 py-1.5 bg-green-50 border border-green-200 rounded-lg text-sm text-green-700 hover:bg-green-100">
                        ...
                        <button type="button"
                            ...
                            class="px-3 py-1.5 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700 hover:bg-red-100">
...
<div id="rejectModal" class="fixed inset-0 z-50 hidden bg-gray-900 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
        ...
        <h3 class="text-xl font-bold mb-4">
            {{ __('messages.booking.reject_booking') }}
        </h3>
