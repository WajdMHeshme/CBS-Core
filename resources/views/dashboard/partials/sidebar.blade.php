    ...
    {{ request()->is('dashboard/customer-lessor-requests*') ? 'bg-indigo-50 text-black font-semibold' : 'text-gray-700 hover:bg-gray-50' }}">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('lessor.lessor.commissions.index') }}"
                        ...
                        <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32px" height="32px" viewBox="0 0 256 173" enable-background="new 0 0 256 173" xml:space="preserve">
